...
class GetPlanningSceneServer : public rclcpp::Node {
 ...
 private:
  ...
  void declareParameters() {
    ...
    // ros2 run pcl_ros pcd_to_pointcloud --ros-args -p file_name:=/home/julian/Downloads/my_debug_cloud.pcd -p frame_id:=base_link -p interval:=1.0
    declare_parameter("output_directory", "/home/julian/Downloads/", "Directory to save output PCD files");
